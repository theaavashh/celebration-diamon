...
const WhatsAppButton = () => {
  const phoneNumber = "9709196495"; // Replace with your actual WhatsApp number
  const message = "Hello! I'm interested in your diamond jewelry collection. Can you help me?";
