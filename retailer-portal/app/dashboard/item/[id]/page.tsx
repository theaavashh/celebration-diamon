        ...
        >
          ...
          >
            ...
            {!authMethod && !isAuthenticated && (
              <div className="space-y-4">
                <p className="text-gray-600 mb-4">Please authenticate to request a quote:</p>
                
                <motion.button
                  onClick={handleFingerprintAuth}
                  className="w-full p-4 border-2 border-blue-600 rounded-xl hover:bg-blue-50 transition-colors flex items-center justify-center space-x-3"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
                  <FaFingerprint className="text-blue-600 text-2xl" />
                  <span className="font-semibold text-gray-900">Use Fingerprint Scanner</span>
                </motion.button>
                ...
                <motion.button
                  ...
                  className="w-full p-4 border-2 border-gray-300 rounded-xl hover:border-blue-600 hover:bg-blue-50 transition-colors flex items-center justify-center space-x-3"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
                  <FaMobile className="text-gray-600 text-2xl" />
                  <span className="font-semibold text-gray-900">Use OTP</span>
                </motion.button>
              </div>
            )}

            {/* Fingerprint Authentication */}
            {authMethod === 'fingerprint' && !isAuthenticated && (
              <div className="text-center py-8">
                {isAuthenticating ? (
                  ...
                  <button
                    onClick={handleFingerprintAuth}
                    className="w-full p-4 border-2 border-blue-600 rounded-xl hover:bg-blue-50 transition-colors"
                  >
                    <FaFingerprint className="text-blue-600 text-3xl mx-auto mb-2" />
                    <span className="text-gray-900 font-semibold">Scan Fingerprint</span>
                  </button>
                )}
              </div>
            )}
            ...
            {/* OTP Authentication */}
            {authMethod === 'otp' && !isAuthenticated && (
                  ...
                  <div className="flex space-x-2">
                    {[...Array(6)].map((_, i) => (
                      <input
                        ...
                        id={`otp-${i}`}
                        className="w-12 h-14 text-center text-2xl font-bold border-2 border-gray-300 rounded-lg focus:border-blue-600 focus:ring-2 focus:ring-blue-200 transition-colors"
                        disabled={isAuthenticating}
                      />
                    ))}
                  </div>
