...
const midBannerRoutes_1 = __importDefault(require("./routes/midBannerRoutes"));
...
const attributeOptionRoutes_1 = __importDefault(require("./routes/attributeOptionRoutes"));
...
app.use(csrfMiddleware_1.csrfValidate);
...
app.use('/api/mid-banners', midBannerRoutes_1.default);
...
app.use('/api/attribute-options', attributeOptionRoutes_1.default);
